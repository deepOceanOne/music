...
<head>
    <meta charset="UTF-8">
    <title>Lcry全网音乐搜索器 - 多站合一音乐搜索,音乐在线试听</title>
    ...
    <meta name="keywords" content="lcry音乐,音乐搜索,音乐试听,音乐在线听,网易云音乐,QQ音乐,酷狗音乐,酷我音乐,虾米音乐,百度音乐,一听音乐,咪咕音乐,荔枝FM,蜻蜓FM,5sing原创音乐,SoundCloud">
    <meta name="description" content="lcry特制多站合一音乐搜索解决方案，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、5sing原创音乐、SoundCloud。">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="lcry音乐搜索器特制多站合一音乐搜索解决方案">
    <meta name="application-name" content="lcry音乐搜索器">
    <meta name="format-detection" content="telephone=no">
    <link rel="shortcut icon" href="static/favicon.ico">
    <link rel="apple-touch-icon" href="static/apple-touch-icon.png">
    <link rel="canonical" href="http://m.yunmain.com/">
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">全网音乐搜索器</h2>
                <p class="am-text-center">全网音乐多站合一搜索解决方案</p>
            </header>
            <hr>
            <div class="am-u-lg-12 am-padding-vertical">
                ...
                <div class="am-u-md-12 am-u-sm-centered am-margin-vertical music-tips">
                    ...
                    <p>
                        <span>SoundCloud (ID)：</span><u>soundcloud://sounds:<b>197401418</b></u> 
                    </p>
                    <p>
...
-->
    ...
    <footer class="footer">
        <p class="am-text-sm">如果获取失败，请 <a href="http://wpa.qq.com/msgrd?v=3&uin=173590787&site=oicqzone.com&menu=yes" target="_blank" rel="author">@lcry</a> © 2015-<?php echo date('Y', time()); ?> <a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">版权声明</a> 
    </footer>
